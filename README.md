...
11. `password` (required): Your UrbanCode Deploy password. This input is marked as a secret.
12. `disableSSLVerification` (optional): A boolean value indicating whether to skip SSL certificate validation when making HTTPS requests. Default is `false`.
